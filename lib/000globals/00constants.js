...
//Single_Valued_Templates = ['form_text','form_text_area','form_password','form_date','date_component'];
Common_Interface_Templates = ['text_component','text_area_component','password_component'];
App_Components = ['labeled_input_text','labeled_input_text_area'];
Single_Valued_Templates = ['input_text','input_text_area'];
